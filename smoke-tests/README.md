...
| `SMOKE_TEST_ENVIRONMENT`    | Target environment: `docker`, `edge`, `beta`, `prod` | `docker`                |
...
| Test                                               | docker | edge | beta | prod |
|----------------------------------------------------|--------|------|------|------|
| Health check (200, valid JSON)                     | ✅      | ☑️   | ☑️   | ☑️   |
| Publish with Basic Auth → 200                      | ☑️     | ☑️   | ☑️   | ☑️   |
| Publish without auth → rejected                    | ☑️     | ☑️   | ☑️   | ☑️   |
| Publish with JWT → 200                             | ☑️     | ☑️   | ☑️   | ☑️   |
| Pub/sub round-trip (subscribe + publish + receive) | ☑️     | ☑️   | ☑️   | ☑️   |
| Private channel subscribe with valid JWT           | ☑️     | ☑️   | ☑️   | ❌    |
| Private channel subscribe without auth → rejected  | ☑️     | ☑️   | ☑️   | ❌    |
...
Admin API tests are docker-only because live environments use Okta OIDC, which requires a browser-based OAuth flow.
