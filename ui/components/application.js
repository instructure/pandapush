...
class Application extends React.Component {
  ...
  loadData() {
    fetch("/admin/api/application/" + this.props.params.id, {
  ...
  componentDidMount() {
    ...
    this.client.subscribe(
      "/" + this.props.params.id + "/meta/statistics",
      msg => {
      ...
      <div className="container">
        <h1>
          ...
          <span style={{ fontSize: "0.6em" }}>
            (<span className="identifier">{this.props.params.id}</span>)
          </span>
        </h1>
        ...
        <div className="row">
          <ul className="nav nav-tabs" role="tablist">
            <li>
              <Link
                to={`/application/${this.props.params.id}/info`}
            ...
            <li>
              <Link
                to={`/application/${this.props.params.id}/keys`}
                activeClassName="active"
              >
                Keys
              </Link>
            ...
            <li>
              <Link
                to={`/application/${this.props.params.id}/console`}
                activeClassName="active"
              >
                Console
              </Link>
            ...
            <li>
              <Link
                to={`/application/${this.props.params.id}/loadtest`}
                activeClassName="active"
              >
                Load Tester
              </Link>
