...
client.subscribeTo(presenceChannel, presenceToken, () => {}).then(
  function() {
...
client
  .subscribeTo(`${masterChannelBase}/jobs`, token, function(message) {
