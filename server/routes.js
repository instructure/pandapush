...
exports.map = function (app, auth) {
  ...
  if (auth) {
    ...
    app.get('/admin/api/application/:applicationId', auth.blocker, admin.getApplication);
    app.delete('/admin/api/application/:applicationId', auth.blocker, admin.deleteApplication);
    app.post('/admin/api/application/:applicationId', auth.blocker, admin.updateApplication);
